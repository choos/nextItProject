...
<body>
	...
	<div class="container" style="margin-top: 50px">
		<div class="login-form" style="margin-top: 150px; margin-bottom: 210px">
			<form action="<%=request.getContextPath()%>/login/login"
				...
				<div class="form-group">
					<div class="input-group">
						...
						<input type="text" class="form-control" name="userId"
							placeholder="사용자 아이디" required="required">
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
				...
				<div class="clearfix">
					<label class="pull-left checkbox-inline"> <input
						type="checkbox" name="idRemember"> Remember me
					</label> <a href="#" class="pull-right">비밀번호 찾기</a>
				</div>
