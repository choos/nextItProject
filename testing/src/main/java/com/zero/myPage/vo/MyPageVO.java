...
public class MyPageVO implements Serializable {
	...
	public String toString() {
		return "MyPageVO [memId=" + memId + ", memPass=" + memPass + ", memName=" + memName + ", memRegno1=" + memRegno1
				+ ", memRegno2=" + memRegno2 + ", memBir=" + memBir + ", memZip=" + memZip + ", memAdd1=" + memAdd1
				+ ", memAdd2=" + memAdd2 + ", memHp=" + memHp + ", memMail=" + memMail + ", memMileage=" + memMileage
				+ ", memDelYN=" + memDelYN + ", memrnum=" + memrnum + "]";
	}
