			...
			<ul class="nav navbar-nav navbar-right">
				...
				<c:if test="${not empty sessionScope.USER_INFO}">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<%=request.getContextPath()%>/myPage/myPage"> <i class="fa fa-id-card-o"
									aria-hidden="true"></i> 회원정보수정
							</a></li>
							<li><a
								href="<%=request.getContextPath()%>/purchase/purchaseList">
									<i class="fa fa-calendar" aria-hidden="true"></i> 구매목록
							</a></li>
							<li><a href="/FAQ/FAQ"> <i class="fa fa-calendar"
									aria-hidden="true"></i> 문의
							</a></li>
							<li class="divider"></li>
