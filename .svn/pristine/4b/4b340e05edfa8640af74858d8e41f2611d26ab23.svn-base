...
<body>
	<div class="container" id="mycon">
		<form action="OTORegist" method="post">
			<table>
				<tr>
					<th>고객 ID</th>
				</tr>
				...
				<tr>
					<td><input type="text" name="reMId" readonly="readonly" class="form-control" value="${user.userId}" ></td>
				</tr>
				<tr>
					<th>답글 제목</th>
				</tr>
				...
				<tr>
					<td><textarea name="reContent" id="summernote" class="summernote"></textarea></td>
				</tr>
				<tr>
